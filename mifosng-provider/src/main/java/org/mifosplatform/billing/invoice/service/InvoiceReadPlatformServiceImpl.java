...
@Service
public class InvoiceReadPlatformServiceImpl implements
		InvoiceReadPlatformService {

	private final JdbcTemplate jdbcTemplate;
	private final PlatformSecurityContext context;

	@Autowired
	public InvoiceReadPlatformServiceImpl(
	...
	private static final class InvoiceMapper implements RowMapper<InvoiceData> {
		...
		public InvoiceData mapRow(final ResultSet rs,
			...
			return new InvoiceData(id, invoiceAmount, dueAmount, invoiceDate,
					billId);
