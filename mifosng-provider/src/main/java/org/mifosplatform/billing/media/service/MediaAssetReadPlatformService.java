...
public interface MediaAssetReadPlatformService {
	...
	List<SettlementData> retriveSettlementDetails(Long mediaId);
	List<SettlementData> retrieveSettlementData(Long id);
	Collection<GameMediaDetailsData> retriveContentProvider();
