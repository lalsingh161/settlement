...
public class TransactionHistoryData {
		...
		private Page<TransactionHistoryData> transactionHistory;
		...
		public TransactionHistoryData(Map<String, Object> da,
				Page<TransactionHistoryData> transactionHistory) {
			this.da = da;
