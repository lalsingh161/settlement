...
public class EventPricingData {
	...
	private Collection<MCodeData> contentProvider;
	private Collection<MCodeData> deck;
	...
	public EventPricingData(List<EnumOptionData> optTypes, List<MediaAssetLocationDetails> format,
			List<DiscountMasterData> discountdata, List<ClientTypeData> clientTypes , Long eventId, Long categoryId) {
this.optTypes = optTypes;
this.format = format;
this.discountdata = discountdata;
this.eventId = eventId;
...
this.categoryId = categoryId;
	...
	public EventPricingData(Collection<MCodeData> optType,
			Collection<MCodeData> format,
			List<DiscountMasterData> discountdata,
			List<ClientTypeData> clientType, Long eventId, Long categoryId) {
		
		
		this.contentProvider = optType;
		this.deck = format;
		this.discountdata = discountdata;
