package org.mifosplatform.billing.businessline.serialization;
...
public class BusinessLineFromApiJsonDeserializer {

	private final Set<String> supportedParameters = new HashSet<String> (Arrays.asList("eventName","chargeCode","eventDescription","status","categoryData","locale","dateFormat"));
	private final FromJsonHelper fromApiJsonHelper;
	
	@Autowired
	public BusinessLineFromApiJsonDeserializer (final FromJsonHelper fromApiJsonHelper) {
	...
	public void validateForCreate(final String json) {
		...
		fromApiJsonHelper.checkForUnsupportedParameters(typeOfMap, json, supportedParameters);
	     ...
	     final DataValidatorBuilder baseDataValidator = new DataValidatorBuilder(dataValidationErrors).resource("businessline");
