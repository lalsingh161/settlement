...
import org.springframework.transaction.annotation.Transactional;
	...
	@Service
	public class  UpdateInteractiveHeaderCommandHandler implements NewCommandSourceHandler{

		final private MediaSettlementWritePlatformService mediaSettlementWritePlatformService;
		
		@Autowired
		public UpdateInteractiveHeaderCommandHandler(final MediaSettlementWritePlatformService mediaSettlementWritePlatformService ) {
			this.mediaSettlementWritePlatformService = mediaSettlementWritePlatformService;
		}
	
		@Override
		public CommandProcessingResult processCommand(final JsonCommand command) {
			return mediaSettlementWritePlatformService.updateInteractiveHeaderData(command.entityId(), command);
