...
@Service
public class CreateClientRoyaltyCommandHandler implements NewCommandSourceHandler{

	final private MediaSettlementWritePlatformService mediaSettlementWritePlatformService;
	
	@Autowired
	public CreateClientRoyaltyCommandHandler(final MediaSettlementWritePlatformService mediaSettlementWritePlatformService ) {
	...
	public CommandProcessingResult processCommand(final JsonCommand command) {
		return mediaSettlementWritePlatformService.createClientRoyalty(command.entityId(), command);
