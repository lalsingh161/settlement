...
@Entity
@Table(name="bp_settle_oem")
public class RevenueOEMSettlement extends AbstractPersistable<Long>{
		...
		public RevenueOEMSettlement() {
			
		}


		public RevenueOEMSettlement(Long mediaCategoryId, Long partnerId,
		...
		public static RevenueOEMSettlement fromJson(JsonCommand command, BigDecimal gPrice) {
			...
			return new RevenueOEMSettlement(mediaCategoryId,partnerId,agreementCategory,playSource,settlementSource,gamePrice,sequence,type,amt,mediaId);
		}
