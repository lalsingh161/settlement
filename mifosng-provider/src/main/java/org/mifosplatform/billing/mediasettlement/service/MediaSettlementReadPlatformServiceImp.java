...
/*
	...
	public List<DisbursementsData> retrieveAllDisbursementsDataDetails(
			String month, String partnerName, Long partnerTypeId) {
		context.authenticatedUser();
	...
	private static final class DistributionDataMapper implements
	  ...
	  " select DISTINCT partner_name as partnerName from bp_settle_vw where partner_type=? and  media_category=?"
	...
	@Override 
	  ...
	  partnerType, String partnerName) { // TODO Auto-generated method stub
	  context.authenticatedUser(); final String sql =
	  " select DISTINCT activity_month as activityMonth FROM  bp_settle_vw s WHERE  partner_type=? and partner_name = ?"
	  ; DisbursementDatesMapper mapper = new DisbursementDatesMapper(); return
	  jdbcTemplate.query(sql, mapper,new Object[]{partnerType,partnerName} );
	  ...
	  return new DisbursementsData(null,activityMonth); } }
