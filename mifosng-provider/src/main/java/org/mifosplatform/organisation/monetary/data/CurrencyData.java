...
public class CurrencyData {
    ...
    public CurrencyData(final Long id, final String currencyCode,final String code, final String name, final int decimalPlaces, final String displaySymbol, final String nameCode) {
    	this.code = code;
    	this.id = id;
        this.name = name;
        this.decimalPlaces = decimalPlaces;
