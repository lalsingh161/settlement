...
public class ClientReadPlatformServiceImpl implements ClientReadPlatformService {
    ...
    public ClientData retrieveTemplate() {
        ...
        ClientData clientData = ClientData.template(officeId, new LocalDate(), offices,categoryDatas);
        Collection<MCodeData> royaltyType = mCodeReadPlatformService.getCodeValue("Royalty Type");
        clientData.setRoyaltyType(royaltyType);
        return clientData;
    }
 ...
 + " where o.hierarchy like ? and pgc.group_id = ?";
    ...
    private static final class ClientMembersOfGroupMapper implements RowMapper<ClientData> {
        ...
        public ClientMembersOfGroupMapper() {
            ...
            /*sqlBuilder.append("c.license_fee as licenseFree,c.royalty_value as royaltyValue, ");*/
        ...
        public ClientData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            /*final String licenseFree=rs.getString("licenseFree");
            final String royaltyValue=rs.getString("royaltyValue");*/
            return ClientData.instance(accountNo, status, officeId, officeName, id, firstname, middlename, lastname, fullname, displayName,
                    externalId, activationDate, imageKey,categoryType,email,phone, null, null,null, null,null,null, null,null,currency/*,licenseFree,royaltyValue*/);
        }
    }
    ...
    private static final class ClientMapper implements RowMapper<ClientData> {
        ...
        public ClientMapper() {
            ...
            /*builder.append("c.license_fee as licenseFree,c.royalty_value as royaltyValue, ");*/
        ...
        public ClientData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            return ClientData.instance(accountNo, status, officeId, officeName, id, firstname, middlename, lastname, fullname, displayName,
                    externalId, activationDate, imageKey,categoryType,email,phone, addressNo, street, city, state, country, zipcode, clientBalance,hwSerial,currency/*,licenseFree,royaltyValue*/);
        }
