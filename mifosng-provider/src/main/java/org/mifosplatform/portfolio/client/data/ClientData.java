...
final public class ClientData implements Comparable<ClientData> {
    ...
    /*private final String licenseFree;
    private final String royaltyValue;*/
    ...
    public static ClientData templateOnTop(final ClientData clientData, final List<OfficeData> allowedOffices, Collection<ClientCategoryData> categoryDatas, List<String> allocationDetailsDatas) {
        ...
        return new ClientData(clientData.accountNo, clientData.status, clientData.officeId, clientData.officeName, clientData.id,
                ...
                clientData.city,clientData.state,clientData.country,clientData.zip,clientData.balanceAmount,allocationDetailsDatas,clientData.hwSerialNumber,clientData.currency/*,clientData.licenseFree,clientData.royaltyValue*/);
    }
    ...
    public static ClientData setParentGroups(final ClientData clientData, final Collection<GroupGeneralData> parentGroups) {
        return new ClientData(clientData.accountNo, clientData.status, clientData.officeId, clientData.officeName, clientData.id,
                ...
                clientData.city,clientData.state,clientData.country,clientData.zip,clientData.balanceAmount,clientData.hardwareDetails,clientData.hwSerialNumber,clientData.currency/*,clientData.licenseFree,clientData.royaltyValue*/);
    }
    ...
    public static ClientData instance(final String accountNo, final EnumOptionData status, final Long officeId, final String officeName,final Long id, 
    		...
    		final String licenseFree, final String royaltyValue*/) {
        return new ClientData(accountNo, status, officeId, officeName, id, firstname, middlename, lastname, fullname, displayName,
                externalId, activationDate, imageKey, null, null,null,categoryType,email,phone,addrNo,street,city,state,country,zip,balanceAmount,null,hwSerialNumber,currency/*,licenseFree,royaltyValue*/);
    }
    ...
    private ClientData(final String accountNo, final EnumOptionData status, final Long officeId, final String officeName, final Long id,
            ...
            String addrNo, String street, String city, String state, String country, String zip, BigDecimal balanceAmount, List<String> hardwareDetails, String hwSerialNumber, String currency/*,String licenseFree,
            String royaltyValue*/) {
