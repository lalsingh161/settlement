...
public class CommandWrapperBuilder {
	...
	public CommandWrapperBuilder createGameMediaAsset() {
		this.actionName = "CREATE";
		this.entityName = "GAMEMEDIAASSET";
		this.entityId = null;
		this.href = "assets/gamedata";
		return this;
	}

	public CommandWrapperBuilder updateGameAsset(Long mediaId) {
		this.actionName = "UPDATE";
		this.entityName = "GAMEMEDIAASSET";
		this.entityId = mediaId;
		this.href = "assets/updateGame" + mediaId;
		return this;
	}

	public CommandWrapperBuilder createPartnerAccount() {
		this.actionName = "CREATE";
		this.entityName = "MEDIASETTLEMENT";
		this.entityId = null;
		this.href = "mediasettlements";
		return this;
	}

	public CommandWrapperBuilder updatePartnerAccount(final Long id) {
		this.actionName = "UPDATE";
		this.entityName = "MEDIASETTLEMENT";
		this.entityId = id;
		this.href = "mediasettlements/" + id;
		return this;
	}

	public CommandWrapperBuilder createPartnerGame() {
		this.actionName = "CREATE";
		this.entityName = "PARTNERGAME";
		this.entityId = null;
		this.href = "mediasettlements/partnergame";
		return this;
	}

	public CommandWrapperBuilder updatePartnerGame(Long id) {
		this.actionName = "UPDATE";
		this.entityName = "PARTNERGAME";
		this.entityId = id;
		this.href = "mediasettlements/partnergame/partnergamedetails/" + id;
		return this;
	}

	public CommandWrapperBuilder createRevenueSettlement() {
		this.actionName = "CREATEREVEN";
		this.entityName = "PARTNERGAME";
		this.entityId = null;
		this.href = "mediasettlements/revenuesettlement/add";
		return this;
	}

	public CommandWrapperBuilder deletePartnerAccount(Long partnerId) {
		this.actionName = "DELETE";
		this.entityName = "MEDIASETTLEMENT";
		this.entityId = partnerId;
		this.href = "/mediasettlements/" + partnerId;
		return this;

	}

	public CommandWrapperBuilder createOperatorDeduction() {
		this.actionName = "CREATE";
		this.entityName = "OPERATORDEDUCTION";
		this.entityId = null;
		this.href = "mediasettlement/deductionoperator/template";
		return this;
	}

	public CommandWrapperBuilder deletePartnerDocument(Long documentId) {
		this.actionName = "DELETEAGREE";
		this.entityName = "MEDIASETTLEMENT";
		this.entityId = documentId;
		this.href = "/mediasettlements/agreement/" + documentId;
		return this;
	}

	public CommandWrapperBuilder deletePartnerGame(Long gameId) {
		this.actionName = "DELETE";
		this.entityName = "PARTNERGAME";
		this.entityId = gameId;
		this.href = "mediasettlements/partnergame/" + gameId;
		return this;

	}

	public CommandWrapperBuilder createDeductionCodes() {
		this.actionName = "CREATE";
		this.entityName = "DEDUCTIONMASTER";
		this.entityId = null;
		this.href = "deductionmaster";
		return this;
	}

	public CommandWrapperBuilder updateDeductionCodes(Long id) {
		this.actionName = "UPDATE";
		this.entityName = "DEDUCTIONMASTER";
		this.entityId = id;
		this.href = "deductionmaster/" + id;
		return this;
	}

	public CommandWrapperBuilder deleteDeductionMaster(Long id) {
	...
	public CommandWrapperBuilder updateSettlementSequenceData() {
		this.actionName = "UPDATE";
		this.entityName = "SETTLEMENTSEQUENCEDATA";
		this.entityId = null;
		this.href = "mediasettlements/settlementSequenceData";
		return this;
	}

	public CommandWrapperBuilder createClientRoyalty(Long clientId) {
		this.actionName = "CREATEROYALTY";
		this.entityName = "MEDIASETTLEMENT";
		this.entityId = clientId;
		this.href = "mediasettlements/client/" + clientId;
		return this;

	}

	public CommandWrapperBuilder createGameEvent(Long clientId) {
		this.actionName = "CREATE";
		this.entityName = "GAMEEVENT";
		this.entityId = clientId;
		this.href = "mediasettlements/creategameevent/" + clientId;
		return this;
	}
	...
	public CommandWrapperBuilder createRevenue(Long clientId) {
		...
		this.entityName = "MEDIASETTLEMENT";
		this.entityId = clientId;
		this.href = "mediasettlements/revenue/" + clientId;
		return this;

	}

	public CommandWrapperBuilder updateRevenue(Long id) {
		this.actionName = "EDITREVENUE";
		this.entityName = "MEDIASETTLEMENT";
		this.entityId = id;
		this.href = "mediasettlements/revenue/" + id;
		return this;
