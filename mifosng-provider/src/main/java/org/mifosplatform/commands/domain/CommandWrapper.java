...
public class CommandWrapper {
	...
	public static CommandWrapper wrap(final String actionName,
			final String entityName, final Long resourceId,
			final Long subresourceId) {
		return new CommandWrapper(null, actionName, entityName, resourceId,
				subresourceId, null);
	}
	...
	public static CommandWrapper fromExistingCommand(final Long commandId,
		...
		return new CommandWrapper(commandId, actionName, entityName,
				resourceId, subresourceId, resourceGetUrl);
	}
	...
	public CommandWrapper(final Long officeId, final Long groupId,
			final Long clientId, final Long loanId, final Long savingsId,
			final String actionName, final String entityName,
			final Long entityId, final Long subentityId, final Long codeId,
			final String supportedEntityType, final Long supportedEntityId,
			final String href, final String json, final String transactionId) {
		this.commandId = null;
	...
	public boolean isUpdate() {
		...
		return (isPermissionResource() && isUpdateOperation())
				|| (isCurrencyResource() && isUpdateOperation())
	...
	public boolean isUpdateRolePermissions() {
		return this.actionName.equalsIgnoreCase("PERMISSIONS")
				&& this.entityId != null;
	}
	...
	public boolean isRevertJournalEntry() {
		return this.actionName.equalsIgnoreCase("REVERSE")
				&& this.entityName.equalsIgnoreCase("JOURNALENTRY");
	}
	...
	public boolean isClientActivation() {
		return this.actionName.equalsIgnoreCase("ACTIVATE")
				&& this.entityName.equalsIgnoreCase("CLIENT");
	}

	public boolean isGroupActivation() {
		return this.actionName.equalsIgnoreCase("ACTIVATE")
				&& this.entityName.equalsIgnoreCase("GROUP");
	}

	public boolean isCenterActivation() {
		return this.actionName.equalsIgnoreCase("ACTIVATE")
				&& this.entityName.equalsIgnoreCase("CENTER");
	}
	...
	public boolean isApproveLoanApplication() {
		return this.actionName.equalsIgnoreCase("APPROVE")
				&& this.entityName.equalsIgnoreCase("LOAN");
	}

	public boolean isUndoApprovalOfLoanApplication() {
		return this.actionName.equalsIgnoreCase("APPROVALUNDO")
				&& this.entityName.equalsIgnoreCase("LOAN");
	}
	...
	public boolean isDisbursementOfLoan() {
		return this.actionName.equalsIgnoreCase("DISBURSE")
				&& this.entityName.equalsIgnoreCase("LOAN");
	}

	public boolean isUndoDisbursementOfLoan() {
		return this.actionName.equalsIgnoreCase("DISBURSALUNDO")
				&& this.entityName.equalsIgnoreCase("LOAN");
	}

	public boolean isLoanRepayment() {
		return this.actionName.equalsIgnoreCase("REPAYMENT")
				&& this.entityName.equalsIgnoreCase("LOAN");
	}

	public boolean isLoanRepaymentAdjustment() {
		return this.actionName.equalsIgnoreCase("ADJUST")
				&& this.entityName.equalsIgnoreCase("LOAN");
	}

	public boolean isWaiveInterestPortionOnLoan() {
		return this.actionName.equalsIgnoreCase("WAIVEINTERESTPORTION")
				&& this.entityName.equalsIgnoreCase("LOAN");
	}

	public boolean isLoanWriteOff() {
		return this.actionName.equalsIgnoreCase("WRITEOFF")
				&& this.entityName.equalsIgnoreCase("LOAN");
	}

	public boolean isCloseLoanAsObligationsMet() {
		return this.actionName.equalsIgnoreCase("CLOSE")
				&& this.entityName.equalsIgnoreCase("LOAN");
	}

	public boolean isCloseLoanAsRescheduled() {
		return this.actionName.equalsIgnoreCase("CLOSEASRESCHEDULED")
				&& this.entityName.equalsIgnoreCase("LOAN");
	}

	public boolean isAddLoanCharge() {
		return this.actionName.equalsIgnoreCase("CREATE")
				&& this.entityName.equalsIgnoreCase("LOANCHARGE");
	}
	...
	public boolean isWaiveLoanCharge() {
		return this.actionName.equalsIgnoreCase("WAIVE")
				&& this.entityName.equalsIgnoreCase("LOANCHARGE");
	}

	public boolean isUpdateLoanOfficer() {
		return this.actionName.equalsIgnoreCase("UPDATELOANOFFICER")
				&& this.entityName.equalsIgnoreCase("LOAN");
	}

	public boolean isRemoveLoanOfficer() {
		return this.actionName.equalsIgnoreCase("REMOVELOANOFFICER")
				&& this.entityName.equalsIgnoreCase("LOAN");
	}

	public boolean isBulkUpdateLoanOfficer() {
		return this.actionName.equalsIgnoreCase("BULKREASSIGN")
				&& this.entityName.equalsIgnoreCase("LOAN");
	}
	...
	public boolean isDeleteOneToOne() {
		...
		return isDatatableResource() && isDeleteOperation()
	...
	public boolean isUpdateOneToOne() {
		return isDatatableResource() && isUpdateOperation()
				&& this.subentityId == null;
	}
	...
	public boolean isUnassignStaff() {
		return this.actionName.equalsIgnoreCase("UNASSIGNSTAFF")
				&& this.entityName.equalsIgnoreCase("GROUP");
	}
	...
	public boolean isUpdateOfOwnUserDetails(final Long loggedInUserId) {
		return this.isUserResource() && isUpdate()
	...
	public boolean isApprovalOfDeposit() {
		return this.actionName.equalsIgnoreCase("APPROVE")
				&& this.entityName.equalsIgnoreCase("DEPOSITACCOUNT");
	}
	...
	public boolean isWithdrawInterest() {
		return this.actionName.equalsIgnoreCase("INTEREST")
				&& this.entityName.equalsIgnoreCase("DEPOSITACCOUNT");
	}

	public boolean isRenewOfDepositApplicaion() {
		return this.actionName.equalsIgnoreCase("RENEW")
				&& this.entityName.equalsIgnoreCase("DEPOSITACCOUNT");
	}
	...
	public boolean isAddressResource() {
		return this.entityName.equalsIgnoreCase("address")
				|| this.entityName.equalsIgnoreCase("city")
				|| this.entityName.equalsIgnoreCase("state")
				|| this.entityName.equalsIgnoreCase("country");
	}
	...
	public boolean isCreateTicket() {
		return this.actionName.equalsIgnoreCase("Create")
				&& this.entityName.equalsIgnoreCase("TICKET");
	}
	...
	public boolean isCreateEvent() {
		return this.actionName.equalsIgnoreCase("CREATE")
				&& this.entityName.equalsIgnoreCase("EVENT");
	}
	...
	public boolean isCreateEventPrice() {
		return this.actionName.equalsIgnoreCase("CREATE")
				&& this.entityName.equalsIgnoreCase("EVENTPRICE");
	}
	...
	public boolean isCreateEventOrder() {
		return this.actionName.equalsIgnoreCase("CREATE")
				&& this.entityName.equalsIgnoreCase("EVENTORDER");
	}

	public boolean isInventoryItemAllocatable() {
		return this.actionName.equalsIgnoreCase("INSERT")
				&& this.entityName.equalsIgnoreCase("ALLOCATION");
	}
	...
	public boolean isCreateMediaAsset() {
		return this.actionName.equalsIgnoreCase("CREATE")
				&& this.entityName.equalsIgnoreCase("MEDIAASSET");
	}
	...
	public boolean isRenewOrder() {
		return this.actionName.equalsIgnoreCase("RENEWAL")
				&& this.entityName.equalsIgnoreCase("ORDER");
	}

	public boolean isReconnectOrder() {
		return this.actionName.equalsIgnoreCase("RECONNECT")
				&& this.entityName.equalsIgnoreCase("ORDER");
	}
	...
	public boolean isCreateBillingMessage() {
		...
		return this.actionName.equalsIgnoreCase("CREATE")
				&& this.entityName.equalsIgnoreCase("BILLINGMESSAGE");
	}

	public boolean isCreateMessageData() {
		// TODO Auto-generated method stub
		return this.actionName.equalsIgnoreCase("CREATEDATA")
				&& this.entityName.equalsIgnoreCase("BILLINGMESSAGE");
	}
	...
	public boolean isUpdateChargeCode() {
		return this.actionName.equalsIgnoreCase("UPDATE")
				&& this.entityName.equalsIgnoreCase("CHARGECODE");
	}

	public boolean isUpdateTaxMap() {
		return this.actionName.equalsIgnoreCase("UPDATE")
				&& this.entityName.equalsIgnoreCase("TAXMAPPING");
	}
	...
	public boolean isConvertClientProspect() {
		return this.entityName.equalsIgnoreCase("PROSPECT")
				&& this.actionName.equalsIgnoreCase("CONVERT");
	}

	public boolean isOwnedHardware() {
		return this.entityName.equalsIgnoreCase("OWNEDHARDWARE")
	...
	public boolean isEpgProgramGuide() {
		return this.entityName.equalsIgnoreCase("EPGPROGRAMGUIDE")
				&& this.actionName.equalsIgnoreCase("CREATE");
	}
	...
	public boolean isUpdateCurrencyConfig() {
		return this.actionName.equalsIgnoreCase("UPDATE")
				&& this.entityName.equalsIgnoreCase("COUNTRYCURRENCY");
	}
	...
	public boolean isCreateRegion() {
		return this.actionName.equalsIgnoreCase("CREATE")
				&& this.entityName.equalsIgnoreCase("REGION");
	}
	...
	public boolean isCreatePaypal() {
		return this.actionName.equalsIgnoreCase("CREATEPAYPAL")
				&& this.entityName.equalsIgnoreCase("PAYMENT");
	}
	...
	public boolean isCreateDiscount() {
		return this.actionName.equalsIgnoreCase("CREATE")
				&& this.entityName.equalsIgnoreCase("DISCOUNT");
	}
	...
	public boolean isCreateMRN() {
		return this.actionName.equalsIgnoreCase("CREATE")
				&& this.entityName.equalsIgnoreCase("MRN");
	}

	public boolean moveMRN() {
		return this.actionName.equalsIgnoreCase("MOVE")
				&& this.entityName.equalsIgnoreCase("MRN");
	}
	...
	public boolean isCreateSupplier() {
		return this.actionName.equalsIgnoreCase("CREATE")
				&& this.entityName.equalsIgnoreCase("SUPPLIER");
	}
	...
	public boolean isCreateRandomGenerator() {
		...
		return this.actionName.equalsIgnoreCase("CREATE")
				&& this.entityName.equalsIgnoreCase("RANDAMGENERATOR");
	}
	...
	public boolean isCreateEntitlement() {
		return this.actionName.equalsIgnoreCase("CREATE")
				&& this.entityName.equalsIgnoreCase("ENTITLEMENT");

	}

	public boolean isClientBalance() {
		return this.actionName.equalsIgnoreCase("CREATE")
				&& this.entityName.equalsIgnoreCase("BALANCE");
	}
	...
	public boolean isRetrackOsdMessageOrder() {
		return this.actionName.equalsIgnoreCase("RETRACKOSDMESSAGE")
				&& this.entityName.equalsIgnoreCase("ORDER");
	...
	public boolean isUpdatePlanMapping() {
		return this.actionName.equalsIgnoreCase("UPDATE")
				&& this.entityName.equalsIgnoreCase("PLANMAPPING");
	}
	...
	public boolean isCreateGameMediaAsset() {
		return this.entityName.equalsIgnoreCase("GAMEMEDIAASSET");
	}

	public boolean isUpdateGameAsset() {
		return this.entityName.equalsIgnoreCase("GAMEMEDIAASSET")
				&& this.actionName.equalsIgnoreCase("UPDATE");
	}

	public boolean isMediaSettlement() {
		return this.entityName.equalsIgnoreCase("MEDIASETTLEMENT");
	}

	public boolean isCreateMediaSettlement() {
		return this.entityName.equalsIgnoreCase("MEDIASETTLEMENT")
				&& this.actionName.equalsIgnoreCase("CREATE");
	}

	public boolean isUpdateGameSettlement() {
		return this.entityName.equalsIgnoreCase("MEDIASETTLEMENT")
				&& this.actionName.equalsIgnoreCase("UPDATE");
	}

	public boolean isPartnerGame() {
		return this.entityName.equalsIgnoreCase("PARTNERGAME");
	}

	public boolean isCreatePartnerGame() {
		return this.entityName.equalsIgnoreCase("PARTNERGAME")
				&& this.actionName.equalsIgnoreCase("CREATE");
	}

	public boolean isUpdatePartnerGame() {
		return this.entityName.equalsIgnoreCase("PARTNERGAME")
				&& this.actionName.equalsIgnoreCase("UPDATE");
	}

	public boolean isCreateRevenueSettlement() {
		return this.entityName.equalsIgnoreCase("PARTNERGAME")
				&& this.actionName.equalsIgnoreCase("CREATEREVEN");
	}

	public boolean isDeleteMediaPartnerSettlement() {
		return this.entityName.equalsIgnoreCase("MEDIASETTLEMENT")
				&& this.actionName.equalsIgnoreCase("DELETE");
	}

	public boolean isOperatorDeduction() {
		return this.entityName.equalsIgnoreCase("OPERATORDEDUCTION");
	}

	public boolean isCreateOperatorDeduction() {
		return this.entityName.equalsIgnoreCase("OPERATORDEDUCTION")
				&& this.actionName.equalsIgnoreCase("CREATE");
	}

	public boolean isUpdateOperatorDeduction() {
		return this.entityName.equalsIgnoreCase("OPERATORDEDUCTION")
				&& this.actionName.equalsIgnoreCase("UPDATE");
	}

	public boolean isDeleteOperatorDeduction() {
		return this.entityName.equalsIgnoreCase("OPERATORDEDUCTION")
				&& this.actionName.equalsIgnoreCase("DELETE");
	}

	public boolean isDeletePartnerAgreement() {
		return this.entityName.equalsIgnoreCase("MEDIASETTLEMENT")
				&& this.actionName.equalsIgnoreCase("DELETEAGREE");
	}

	public boolean isDeletePartnerGame() {
		return this.entityName.equalsIgnoreCase("PARTNERGAME")
				&& this.actionName.equalsIgnoreCase("DELETE");
	}

	public boolean isMasterDeduction() {
		return this.entityName.equalsIgnoreCase("DEDUCTIONMASTER");
	}

	public boolean isCreateDeductionCodes() {
		return this.entityName.equalsIgnoreCase("DEDUCTIONMASTER")
				&& this.actionName.equalsIgnoreCase("CREATE");
	}

	public boolean isUpdateDeductionCodes() {
		return this.entityName.equalsIgnoreCase("DEDUCTIONMASTER")
				&& this.actionName.equalsIgnoreCase("UPDATE");
	}

	public boolean isDeleteDeductionMaster() {
		return this.entityName.equalsIgnoreCase("DEDUCTIONMASTER")
				&& this.actionName.equalsIgnoreCase("DELETE");
	}

	public boolean isUpdateSettlementSequenceData() {
		return this.entityName.equalsIgnoreCase("SETTLEMENTSEQUENCEDATA")
				&& this.actionName.equalsIgnoreCase("UPDATE");
	}

	public boolean isCreateRoyalty() {
		return this.entityName.equalsIgnoreCase("MEDIASETTLEMENT")
				&& this.actionName.equalsIgnoreCase("CREATE");
	}
	...
	public boolean isCreateRevenue() {
		return this.entityName.equalsIgnoreCase("MEDIASETTLEMENT")
				&& this.actionName.equalsIgnoreCase("CREATEREVENUE");
	}

	public boolean isUpdateRevenue() {
		return this.entityName.equalsIgnoreCase("MEDIASETTLEMENT")
				&& this.actionName.equalsIgnoreCase("EDITREVENUE");
	}
